...
import SerachInvoice from '../Components/SerachInvoice'
...
<div className="flex flex-row px-3"></div>
<div className="w-12/12 pt-3 px-3">
                ...
                <table className="table">
                    <thead>
                        <tr>
                            ...
                            <th className='text-xl'>PO Number</th>
