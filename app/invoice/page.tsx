...
function invoice() {
  ...
  return (
      ...
      <div className='bg-primary text-center text-4xl top-10 font-black w-full rounded '>PURCHACE ORDER</div>
         ...
         <input type="text" placeholder="PO Number" className="input input-bordered input-primary w-full max-w-xs" />
         <input type="text" placeholder="Customer Name" className="input input-bordered input-primary w-full max-w-xs" />
         <input type="text" placeholder="Customer Email" className="input input-bordered input-primary w-full max-w-xs" />
         ...
         <input type="text" placeholder="Customer Address" className="input input-bordered input-primary w-full max-w-xs" />
