    ...
    <table className="table">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div><input type="text" placeholder="0" className="input input-sm  w-full max-w-xs" /></div>
                    </td>
                    <td>
                    <input type="text" placeholder="0" className="input input-sm w-full max-w-xs" />
                    </td>
