                    ...
                    <tbody>
                        {stocks.map((stock) => (
                            <tr key={stock.id}>
                                ...
                                <td>
                                    <button className="btn btn-sm btn-error" onClick={() => setDeleteModalOpen(true)}>
                                    ...
                                    <DeleteModal onClose={() => setDeleteModalOpen(false)} isOpen={isDeleteModalOpen} title='Delete Stock' onSubmit={() => handleDeleteStock(stock)} />
                                </td>
                            </tr>
                        ))}
